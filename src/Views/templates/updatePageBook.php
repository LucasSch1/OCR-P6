...
<section class="container-modification-book">
    <div class="return-container">
        <a href="?action=privateAccountUser" class="back-link"><img src="../public/assets/arrow_return.svg" alt="icon d'une flèche pour retourner en arrière"> retour</a>
    </div>
    ...
    <div class="container-main">
        <div class="container-photo">
            ...
            <form action="index.php?action=updateBookPicture" method="POST" enctype="multipart/form-data">
                <div class="container-image-book">
                    <img src="../<?php echo htmlspecialchars($book[0]['COVER']); ?>" alt="Image du livre à mettre a jour">
                </div>
        ...
        <div class="container-informations">
            <form method="POST" action="?action=updateBook">
                ...
                <input type="text" id="titlebookUpdate" name="titlebookUpdate" value="<?php echo htmlspecialchars($book[0]['TITLE']); ?>">
                <label for="authorUpdate">Auteur</label>
                <input type="text" id="authorUpdate" name="authorUpdate" value="<?php echo htmlspecialchars($book[0]['AUTHOR']); ?>">
                <label for="commentaryUpdate">Commentaire</label>
                <textarea id="commentaryUpdate" name="commentaryUpdate" class="commentary-container" rows="17"><?php echo htmlspecialchars($book[0]['DESCRIPTION']); ?></textarea>

                <label for="disponibility-choice-book">Disponibilité</label>
